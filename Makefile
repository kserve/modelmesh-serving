...
fvt:
	ginkgo --junit-report=junit_fvt.xml -output-dir=target/test-reports/ -keep-separate-reports -v -p -progress --fail-fast fvt/predictor fvt/scaleToZero --timeout=40m
